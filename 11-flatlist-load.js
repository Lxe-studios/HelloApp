...
import { Button, View, Text, FlatList, StyleSheet, ActivityIndicator } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        // 自定义 下拉刷新
        // refreshControl= {
        //   <RefreshControl tintColor='#ff0000'></RefreshControl>
        // }
        ListFooterComponent={() => _loadComponent()}
...
const dataArray = [{ key: 1, province: 'hunan' }, { key: 2, province: '广东' }, { key: 3, province: '浙江' }, { key: 4, province: '江苏' }, { key: 5, province: '上海' }, { key: 6, province: '福建' }, { key: 7, province: '江西' }]
